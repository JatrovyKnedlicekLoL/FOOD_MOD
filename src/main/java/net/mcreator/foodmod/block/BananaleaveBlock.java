...
public class BananaleaveBlock extends FoodModModElements.ModElement {
	@ObjectHolder("food_mod:bananaleave")
	public static final Block block = null;
	public BananaleaveBlock(FoodModModElements instance) {
		super(instance, 61);
	}
