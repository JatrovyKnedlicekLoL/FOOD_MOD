...
import net.mcreator.foodmod.item.BlueberryItem;
...
public class BlueberrybushmBlock extends FoodModModElements.ModElement {
	@ObjectHolder("food_mod:blueberrybushm")
	public static final Block block = null;
	public BlueberrybushmBlock(FoodModModElements instance) {
		super(instance, 91);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blueberrybushm"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("food_mod:blueberrybushm"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("blueberrybushm");
		}
