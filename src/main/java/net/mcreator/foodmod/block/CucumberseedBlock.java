...
import net.mcreator.foodmod.item.CucubberItem;
...
public class CucumberseedBlock extends FoodModModElements.ModElement {
	@ObjectHolder("food_mod:cucumberseed")
	public static final Block block = null;
	public CucumberseedBlock(FoodModModElements instance) {
		super(instance, 92);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cucumberseed"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("food_mod:cucumberseed"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CucubberItem.block, (int) (2)));
		}
