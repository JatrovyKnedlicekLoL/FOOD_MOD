...
public class CucumberseedsnBlock extends FoodModModElements.ModElement {
	@ObjectHolder("food_mod:cucumberseedsn")
	public static final Block block = null;
	public CucumberseedsnBlock(FoodModModElements instance) {
		super(instance, 93);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cucumberseedsn"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("food_mod:cucumberseedsn"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("cucumberseedsn");
		}
