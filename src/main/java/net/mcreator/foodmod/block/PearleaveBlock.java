...
public class PearleaveBlock extends FoodModModElements.ModElement {
	@ObjectHolder("food_mod:pearleave")
	public static final Block block = null;
	public PearleaveBlock(FoodModModElements instance) {
		super(instance, 62);
	}
