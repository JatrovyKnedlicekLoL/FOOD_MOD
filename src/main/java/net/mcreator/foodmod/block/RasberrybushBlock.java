...
public class RasberrybushBlock extends FoodModModElements.ModElement {
	@ObjectHolder("food_mod:rasberrybush")
	public static final Block block = null;
	public RasberrybushBlock(FoodModModElements instance) {
		super(instance, 50);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rasberrybush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("food_mod:rasberrybush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RaspberryItem.block, (int) (4)));
		}
