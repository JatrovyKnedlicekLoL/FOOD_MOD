...
import net.mcreator.foodmod.item.StrawberryItem;
...
public class StrawberrybushBlock extends FoodModModElements.ModElement {
	@ObjectHolder("food_mod:strawberrybush")
	public static final Block block = null;
	public StrawberrybushBlock(FoodModModElements instance) {
		super(instance, 62);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("strawberrybush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("food_mod:strawberrybush"), configuredFeature);
		}
	}
	@SubscribeEvent
