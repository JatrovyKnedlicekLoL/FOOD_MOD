...
public class TomatoseedBlock extends FoodModModElements.ModElement {
	@ObjectHolder("food_mod:tomatoseed")
	public static final Block block = null;
	public TomatoseedBlock(FoodModModElements instance) {
		super(instance, 94);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tomatoseed"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("food_mod:tomatoseed"), configuredFeature);
		}
	}
	@SubscribeEvent
