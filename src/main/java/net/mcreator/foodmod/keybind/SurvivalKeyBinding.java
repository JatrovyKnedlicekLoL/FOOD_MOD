...
import net.mcreator.foodmod.procedures.SurvivalOnKeyPressedProcedure;
...
public class SurvivalKeyBinding extends FoodModModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public SurvivalKeyBinding(FoodModModElements instance) {
		super(instance, 48);
	...
	public void initElements() {
		keys = new KeyBinding("key.food_mod.survival", GLFW.GLFW_KEY_L, "key.categories.misc");
