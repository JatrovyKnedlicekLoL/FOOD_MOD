...
public class FoodbiomBiome extends FoodModModElements.ModElement {
	public static Biome biome;
	public FoodbiomBiome(FoodModModElements instance) {
		super(instance, 19);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-13382401).setWaterColor(-13369396).setWaterFogColor(-16737895)
						.withSkyColor(-13382401).withFoliageColor(10387789).withGrassColor(-13382656)
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.HORSE, 20, 2, 4));
				...
				event.getRegistry().register(biome.setRegistryName("food_mod:foodbiom"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("foodbiom_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("foodbiom_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
